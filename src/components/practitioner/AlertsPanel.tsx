import { AlertTriangle, CheckCircle, Clock, Camera, XCircle } from 'lucide-react';
...
interface AlertsPanelProps {
  alerts: Array<Alert & { patientName: string; patientId: string }>;
  onResolve?: (alertId: string) => void;
  onViewPatient?: (patientId: string) => void;
}

export function AlertsPanel({ alerts, onResolve, onViewPatient }: AlertsPanelProps) {
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs opacity-60">
                  {format(alert.createdAt, 'd MMM HH:mm', { locale: fr })}
                </span>
              </div>
